      ...
      <motion.div initial={{ opacity: 0 }}
        ...
        <h4 className="text-lg font-bold text-center text-sky-700">Découvrir nos services</h4>
          <motion.div animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            transition={{ duration: 1 }} className="grid gap-3 mt-7 md:grid-cols-4 mb-7" variants={fadeIn('right', 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.4}}> 
